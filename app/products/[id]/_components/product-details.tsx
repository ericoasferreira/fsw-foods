...
import { formatCurrency, calculateProductTotalPrice } from "@/app/_components/_helpers/price";
        ...
        <div className="relative z-50 py-5 mt-[-1.5rem] rounded-tl-3xl rounded-tr-3xl bg-white">
            ...
            <div className="flex justify-between px-5">
                ...
                <div className="flex items-center gap-3 text-center">
                    ...
                    <Button size="icon" className="border border-solid border-primary" onClick={handleIncreaseQuantityClick}>
                        <ChevronRightIcon />
                    </Button>
                </div>
            </div>

            <Card className="flex justify-around py-3 mt-6 mx-5">
